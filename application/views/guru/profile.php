                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="widget-heading text-center">
                                ...
                                <p style="margin-top: -3px;">GURU CBT-MALELA</p>
                                ...
                                <div class="d-flex justify-content-center">
                                    <table cellpadding="2" class="mt-3 text-center">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javasript:void(0)" class="btn btn-primary profile-guru" data-guru="<?= encrypt_url($guru->id_guru); ?>" data-toggle="modal" data-target="#edit_profile">Upadete Profile</a>
                                            </td>
                                            <td>
                                                <a href="javasript:void(0)" class="btn btn-primary password-guru" data-guru="<?= encrypt_url($guru->id_guru); ?>" data-toggle="modal" data-target="#edit_password">Upadete Password</a>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
...
<div class="modal fade" id="edit_password" tabindex="-1" role="dialog" aria-labelledby="edit_passwordLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="<?= base_url('guru/update_password'); ?>" method="POST">
