                        ...
                        <div class="col-lg-6">
                            <ul class="list-group list-group-media">
                                ...
                                <?php foreach ($tugas_siswa as $ts) : ?>
                                    <?php $siswa = $this->db->get_where('siswa', ['id_siswa' => $ts->siswa])->row(); ?>
                                    <?php if ($ts->date_send === null) : ?>
                                        <li class="list-group-item list-group-item-action">
                                            <div class="media">
                                                <div class="mr-3">
                                                    <img alt="avatar" src="<?= base_url('assets/app-assets/user/') . $siswa->avatar; ?>" class="img-fluid rounded-circle">
                                                </div>
                                                <div class="media-body">
                                                    <h6 class="tx-inverse"><?= $siswa->nama_siswa; ?></h6>
